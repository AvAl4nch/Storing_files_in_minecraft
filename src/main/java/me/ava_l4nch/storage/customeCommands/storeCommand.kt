    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>?): Boolean {
        if (sender is Player) {
            if (sender.isOp) {
                if (args != null) {
                    if (args.size < 3) {
                        sender.sendMessage(ChatColor.RED.toString() + "Usage: /store <startX> <y> <z> <block>")
                        return true
                    }
                }
                val blocks = listOf(
                ...
                try {
                    ...
                    val blockType = args?.get(3)?.uppercase(Locale.getDefault()) ?: return false
                    val slot_size = 32
                    var c = 0
                    ...
                    sender.sendMessage(ChatColor.GREEN.toString() + "Blocks set  $x to ${x + 9} at ($y, $z) to $blockType")
                    return true
